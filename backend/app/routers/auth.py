...
def upsert_profile(payload: UserProfileUpsertRequest, authorization: Optional[str] = Header(default=None)):
    ...
    try:
        return auth_otp_store.upsert_user_profile(
            ...
            dog_sex_neuter=payload.dog_sex_neuter,
            dog_weight_class=payload.dog_weight_class,
            ...
            play_energy_level=payload.play_energy_level,
            play_style=payload.play_style,
            social_confidence=payload.social_confidence,
            trigger_notes=payload.trigger_notes,
            ideal_match=payload.ideal_match,
            walk_preferences=payload.walk_preferences,
            training_style=payload.training_style,
            feeding_rules=payload.feeding_rules,
            consent_boundaries=payload.consent_boundaries,
            vaccination_status=payload.vaccination_status,
            microchipped=payload.microchipped,
            recall_trained=payload.recall_trained,
            leash_reliability=payload.leash_reliability,
